...
class ArrowGUI:
    def __init__(self):
        ...
        self.directions_per_session = 10  # Total directions per session
        self.directions_per_class = 5     # Directions per class (12/4 = 3)
    ...
    def setup_ui(self):
        ...
        session_title = tk.Label(
            session_frame,
            text="Current Session (10 directions):",
            font=('Arial', 10, 'bold'),
            fg='#95a5a6',
            bg='#2c3e50'
        )
    ...
    def start_collection(self):
        ...
        print("Rest periods: {:.1f}s between directions, {:.1f}s after 10 directions".format(
    ...
    def highlight_next_direction(self):
        ...
        if self.direction_count > 0 and self.direction_count % 10 == 0:
        ...
        # Update status
        self.status_label.config(text=f"Set {self.current_set}/{self.total_sets} - Focus on: {selected_direction} ({self.direction_count}/10)")
